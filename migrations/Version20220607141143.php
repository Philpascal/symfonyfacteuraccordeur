 ...
 */
final class Version20220607141143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD marque_id INT NOT NULL, ADD couleur_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP marque_id, DROP couleur_id');
    }
}
